locals {
  ...
  combined_objects_service_plans                                  = merge(tomap({ (local.client_config.landingzone_key) = module.service_plans }), try(var.remote_objects.service_plans, {}))
  ...
  combined_objects_iothubs                                        = merge(tomap({ (local.client_config.landingzone_key) = module.iothubs }), try(var.remote_objects.iothubs, {}))
  # combined_objects_iothub_endpoints                               = merge(tomap({ (local.client_config.landingzone_key) = module.iothub_endpoints }), try(var.remote_objects.iothub_endpoints, {}))
  ...
  combined_objects_virtual_hub_route_maps                         = merge(tomap({ (local.client_config.landingzone_key) = module.virtual_hub_route_maps }), try(var.remote_objects.virtual_hub_route_maps, {}))
