resource "azurerm_mssql_server" "mssql" {
  ...
  dynamic "azuread_administrator" {
    ...
    content {
      ...
      login_username              = try(var.settings.azuread_administrator.login_username, var.azuread_groups[try(var.settings.azuread_administrator.lz_key, var.client_config.landingzone_key)][var.settings.azuread_administrator.azuread_group_key].name, null)
      object_id                   = try(var.settings.azuread_administrator.object_id, var.azuread_groups[try(var.settings.azuread_administrator.lz_key, var.client_config.landingzone_key)][var.settings.azuread_administrator.azuread_group_key].id, null)
