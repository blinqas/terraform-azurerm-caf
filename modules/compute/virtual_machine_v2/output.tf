...
output "admin_username" {
  #value       = lower(local.os_type) == "linux" ? try(local.admin_username_linux, null) : can(local.admin_username) ? local.admin_username : null
  value = try(local.admin_username, null)
