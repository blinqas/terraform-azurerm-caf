  ...
  dynamic "bgp_settings" {
    ...
    content {
      ...
      dynamic "peering_addresses" {
        for_each = try(bgp_settings.peering_addresses, {})
        content {
          ip_configuration_name = peering_addresses.ip_configuration_name
          apipa_addresses = peering_addresses.apipa_addresses
        }
